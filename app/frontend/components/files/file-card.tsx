      ...
      >
        ...
        {isDownloading && (
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 25%, rgba(0,213,228,0.4) 50%, transparent 75%)",
              backgroundSize: "200% 100%",
          ...
          <div
            className={cn(
              ...
              isDownloading
                ...
                : isDone
                  ? "bg-cyan-500/15"
                  : "bg-[var(--color-surface)]/80 backdrop-blur-sm shadow-sm",
            )}
          >
            {isDownloading ? (
          ...
          >
            {onPreview && (
              <IconButton
                ...
                className="h-10 w-10 rounded-xl bg-[var(--color-surface)]/90 hover:bg-[var(--color-surface)] shadow-sm"
              />
            )}
            <IconButton
              icon={Download}
            ...
            <IconButton
              ...
              className="h-10 w-10 rounded-xl bg-[var(--color-surface)]/90 hover:bg-[var(--color-surface)] shadow-sm [&_svg]:text-red-400/60 hover:[&_svg]:text-red-400"
            />
          </div>
        )}
      </div>
      ...
      <div className="p-3.5 flex-1 min-w-0 space-y-2">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {isDownloading ? (
              <span className="text-xs text-cyan-400 font-medium animate-pulse-soft">
                Downloading...
              </span>
            ) : isDone ? (
              ...
              <>
                <span className="text-xs text-[var(--color-text-muted)]">&middot;</span>
                <span
                  className={`text-xs font-medium ${wasCompressed ? "text-cyan-500" : "text-[var(--color-text-muted)]"}`}
                >
