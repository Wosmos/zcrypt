...
const RULES: { icon: Icon; keys: string[] }[] = [
  ...
  {
    icon: FilmSlate,
    keys: ["movies", "movie", "videos", "video", "films", "film", "clips", "footage"],
  },
  { icon: Monitor, keys: ["desktop"] },
  {
    icon: SquaresFour,
    keys: ["applications", "application", "apps", "app", "programs", "software"],
  },
  ...
  {
    icon: Briefcase,
    keys: ["work", "job", "jobs", "business", "office", "clients", "client", "company"],
  },
  ...
  {
    icon: Palette,
    keys: ["design", "designs", "art", "graphics", "assets", "icons", "figma", "sketch", "mockups"],
  },
  ...
  {
    icon: UsersThree,
    keys: ["shared", "share", "team", "teams", "family", "group", "groups", "collab"],
  },
