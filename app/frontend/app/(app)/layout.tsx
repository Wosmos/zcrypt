      ...
      <VaultLockProvider>
        ...
        <div className="app-shell flex h-dvh gap-0 bg-[var(--color-bg)] p-0 md:gap-3 md:p-3">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-0 md:gap-3">
            ...
            <main
              id="main-content"
              className="panel min-h-0 flex-1 overflow-y-auto rounded-none border-0 shadow-none pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:rounded-[1.25rem] md:border md:shadow-[0_1px_2px_rgba(16,24,40,0.04),0_4px_12px_-6px_rgba(16,24,40,0.08)] md:pb-0"
            >
