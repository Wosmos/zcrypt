  ...
  return (
    ...
    >
      ...
      <DocSection id="storage" title="How much storage do I get?">
        <DocP>
          You bring your own storage (BYOB). Connect a GitHub, GitLab, Hugging Face, or Telegram
          account and your capacity is whatever free space that platform gives you. zcrypt handles
          the compression, encryption, and chunking on top of it, and rotates across repositories as
          they fill, so you keep growing without hitting an artificial cap.
        </DocP>
      </DocSection>
      ...
      <DocSection id="folders" title="Does zcrypt have real folders, or just a flat list?">
        <DocP>
          Real folders. zcrypt is a full encrypted drive: create and nest folders, drag files to
          organize them, search, sort, and switch between grid and list views. Folder names are
          encrypted too, so even your structure stays private. See{" "}
      ...
      <DocSection id="folder-password" title="Can I password-protect a single folder?">
        <DocP>
          Yes. Any folder can have its own password, separate from your account passphrase. The
          files inside are re-encrypted under that folder's key, so even with your vault unlocked, a
          protected folder stays sealed until you enter its password. See{" "}
          <Link
      ...
      <DocSection id="forgot" title="What happens if I forget my passphrase?">
        ...
        <DocNote type="warning" title="Back up your passphrase">
          Store your passphrase in a password manager. It is the one secret that unlocks everything,
          and the one thing we genuinely cannot help you recover.
        </DocNote>
      </DocSection>
    </DocPage>
  );
