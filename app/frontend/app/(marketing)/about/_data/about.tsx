  ...
  origin: {
    ...
    paragraphsBeforeQuote: [
      ...
      <>
        ...
        reasonable thing: I made a second account. Then a third. For about a week I was splitting
        one folder across three logins like a low-budget digital smuggler, quietly proud of a system
        held together with tape.
      </>,
      <>
        Then I tried TeraBox. &ldquo;One terabyte, free,&rdquo; they said. What they didn&apos;t
        say: the download button is hidden like a state secret, your files quietly live on{" "}
        <em>their</em> servers, and the fine print treats your data as theirs to scan and learn
        from. It really clicked when I uploaded a 4GB folder, watched it crawl to 80%, and watched
        it fail. My first thought wasn&apos;t &ldquo;let me retry.&rdquo; It was &ldquo;why am I
        handing my entire life to a company whose whole business is knowing what&apos;s inside
        it?&rdquo;
      </>,
      <>
      ...
      <>
        ...
        extra steps. The idea was simple even though the code very much wasn&apos;t: encrypt your
        files on your device before they leave, so not even I can read them, then store them across
        the infrastructure you already own and trust. No new data empire. No &ldquo;we value your
        privacy&rdquo; banner that means the exact opposite. Just your files, locked, yours.
      </>,
    ],
    pullQuote: (
      <>
