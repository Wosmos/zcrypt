...
describe("shared-space + key API wrappers", () => {
  ...
  const cases: Case[] = [
    ...
    { name: "addFileToSpace", run: () => addFileToSpace("v1", "f2", "cek", "nm"), path: "/api/shared-vaults/v1/files", method: "POST", body: { file_id: "f2", wrapped_cek: "cek", wrapped_name: "nm" } },
    { name: "removeFileFromSpace", run: () => removeFileFromSpace("v1", "f2"), path: "/api/shared-vaults/v1/files/f2", method: "DELETE" },
    { name: "rotateSpace", run: () => rotateSpace("v1", [{ user_id: "u", wrapped_space_key: "k" }], [{ file_id: "f", wrapped_cek: "c", wrapped_name: "n" }]), path: "/api/shared-vaults/v1/rotate", method: "POST", body: { members: [{ user_id: "u", wrapped_space_key: "k" }], files: [{ file_id: "f", wrapped_cek: "c", wrapped_name: "n" }] } },
